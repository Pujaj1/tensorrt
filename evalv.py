...
def generate_priors():
    feature_map_sizes = [[50, 50], [25, 25], [13, 13], [7, 7], [4, 4]]
...
def postprocess(output, original_shape):
    ...
    for m in masks:
        ...
        resized_masks.append(resized > 0.3)
...
if __name__ == "__main__":
    model_path = "/home/puja/yolact/weights/yolact_im400_0_6109_interrupt.onnx"
    yolact = YolactONNX(model_path)

    cap = cv2.VideoCapture("/home/puja/yolact/People Walking Free Stock Footage, Royalty-Free No Copyright Content.mp4")  
    ...
    while True:
        ...
        #print(fps)
        cv2.imshow("YOLACT", frame.astype(np.uint8))
